...
const formatSubstanceDisplay = (s: {
  layer_1: string
  layer_1_type: string
  layer_2: string
  layer_2_type: string
...
export default function SinglefaceSettingsPage() {
  ...
  if (loading && substances.length === 0 && !error) {
    return (
      <LoadingState
        message="Memuat Data Singleface..."
          ...
          {substances.length === 0 ? (
            <div className="flex flex-col items-center gap-3 py-16">
              ...
              <p className="text-sm text-gray-400">
                Tambahkan singleface substance baru untuk memulai
              </p>
              <Button
                onClick={() => setShowAddModal(true)}
                variant="primary"
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3">
                          <div className="flex flex-col gap-1">
                            <div className="flex items-center gap-1">
                              {[substance.layer_1_type, substance.layer_2_type].map(
                                (code, idx) => {
                      ...
                      <td className="px-6 py-4">
                        <Badge color={l1Meta.bg} light={l1Meta.light}>
                          {substance.layer_1}
                          {substance.layer_1_type}
                        </Badge>
                      </td>
                      <td className="px-6 py-4">
                        <Badge color={l2Meta.bg} light={l2Meta.light}>
                          {substance.layer_2}
                          {substance.layer_2_type}
                        </Badge>
                      </td>
                ...
                <Card key={num} shadow="sm" padding="md" className="border-l-4 border-l-blue-500">
                  ...
                  <div className="space-y-3">
                    ...
                    <Select
                      label="Jenis Kertas *"
                      value={
                        addFormData[`layer_${num}_type` as 'layer_1_type' | 'layer_2_type']
                      }
                      onChange={(e: React.ChangeEvent<HTMLSelectElement>) => {
                        setAddFormData(prev => ({
                          ...prev,
                          [`layer_${num}_type`]: e.target.value,
                        }))
                      }}
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      ...
                      <Select
                        label="Jenis Kertas *"
                        value={
                          editFormData[`layer_${num}_type` as 'layer_1_type' | 'layer_2_type']
                        }
                        onChange={(e: React.ChangeEvent<HTMLSelectElement>) => {
                          setEditFormData(prev => ({
                            ...prev,
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <div className="flex gap-1">
                        {[selectedItem.layer_1_type, selectedItem.layer_2_type].map(
                          (code, idx) => {
                            const meta = getLayerMeta(code)
                            return (
                              <span
                ...
                <Card shadow="none" padding="sm" bordered>
                  ...
                  <div className="space-y-2">
                    {[
                      {
                        num: 1,
                        gsm: selectedItem.layer_1,
                        type: selectedItem.layer_1_type,
                        meta: l1Meta,
                      },
                      {
                        num: 2,
                        gsm: selectedItem.layer_2,
                        type: selectedItem.layer_2_type,
                        meta: l2Meta,
                      },
                      ...
                      >
                        ...
                        <span className="text-xs text-gray-400">
                          {LAYER_TYPE_OPTIONS.find(o => o.value === type)
                            ?.label?.split(' - ')[1] || type}
                        </span>
                      </div>
                    ))}
